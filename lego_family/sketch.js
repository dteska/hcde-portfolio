...
function shaggy() { // Sending Shaggy from 930, 30 to 535, 308. Moves 395 across and 278 down.
  ...
  rect(xpos3, ypos3 - 60, 42, 25); // hair rectangle 
  fill(255, 233, 196); // shaggy's face
  rect(xpos3, ypos3 - 35, 42, 26); // face rectangle
  fill(222, 226, 42); // shaggy's shirt
  rect(xpos3, ypos3 - 10, 42, 92); // shirt rectangle
  fill(168, 84, 73); // shaggy's pants
  rect(xpos3, ypos3 + 71, 42, 51); // pants rectangle
  fill(0, 28, 45); // shaggy's shoes
  rect(xpos3, ypos3 + 122, 42, 12); // shoe rectangle
}
